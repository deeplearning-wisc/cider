...
def parse_option():
    ...
    opt.model_name = 'SupCE_{}_{}_lr_{}_decay_{}_bsz_{}_trial_{}_feat_mormalize_{}'.\
        format(opt.dataset, opt.model, opt.learning_rate, opt.weight_decay,
               opt.batch_size, opt.trial, opt.normalize)
...
def set_model(opt):
    model = SupCEResNet(name=opt.model, normalize = opt.normalize, num_classes=opt.n_cls)
